...
export const AuthProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  const login = async (phone: string, pin: string) => {
    try {
      ...
      console.error(e);
      throw new Error(e.message || "Failed to sign in. Check your phone and PIN.");
    }
  };
  ...
  return (
    <AuthContext.Provider value={{ user, loading, pendingVerification: pendingVerificationState, setPendingVerification, login, register, logout }}>
      {children}
