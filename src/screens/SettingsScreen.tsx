      ...
      <div className="p-4 space-y-6 flex-1 overflow-y-auto pb-24">
        ...
        <section className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
          <div className="px-4 py-3 border-b border-gray-50 dark:border-gray-700 flex items-center space-x-2 bg-gray-50/50 dark:bg-gray-800/50">
            ...
            <h3 className="text-sm font-bold text-gray-700 dark:text-gray-300">App Language</h3>
          </div>
          <div className="p-2">
        ...
        <section className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
          <div className="px-4 py-3 border-b border-gray-50 dark:border-gray-700 flex items-center space-x-2 bg-gray-50/50 dark:bg-gray-800/50">
            ...
            <h3 className="text-sm font-bold text-gray-700 dark:text-gray-300">Appearance & Alerts</h3>
          </div>
            ...
            <div className="flex items-center justify-between px-4 py-3">
              <div className="flex items-center space-x-3 text-sm text-gray-700 dark:text-gray-300 font-medium">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-gray-500 dark:text-gray-400 font-normal">Timely task & crop alerts</p>
                </div>
              </div>
              <button 
        ...
        <section className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
          <div className="px-4 py-3 border-b border-gray-50 dark:border-gray-700 flex items-center space-x-2 bg-gray-50/50 dark:bg-gray-800/50">
            ...
            <h3 className="text-sm font-bold text-gray-700 dark:text-gray-300">Account Security</h3>
          </div>
          <div className="p-4">
            {!showPasswordChange ? (
              <button 
